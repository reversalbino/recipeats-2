window.addEventListener("DOMContentLoaded", (e) => {
  ...
  <div class="feedback">
    <div class="rating">
      <input type="radio" name="rating" value = '5' userId = ${tempUserId} id="rating-5">
      <label for="rating-5"></label>
      <input type="radio" name="rating" value = '4' userId = ${tempUserId} id="rating-4">
      <label for="rating-4"></label>
      <input type="radio" name="rating" value = '3' userId = ${tempUserId} id="rating-3">
      <label for="rating-3"></label>
      <input type="radio" name="rating" value = '2' userId = ${tempUserId} id="rating-2">
      <label for="rating-2"></label>
      <input type="radio" name="rating" value = '1' userId = ${tempUserId} id="rating-1">
